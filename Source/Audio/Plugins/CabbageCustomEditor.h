...
#ifndef CabbageCustomEditor_H_INCLUDED
#define CabbageCustomEditor_H_INCLUDED
...
public:
    ...
    CabbageCustomProcessor& getProcessor();
...
private:
    ...
    CabbageCustomProcessor& cabbageProcessor;
...
#endif  // CabbageCustomEditor_H_INCLUDED
