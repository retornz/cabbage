...
//==============================================================================
CabbageCustomEditor::CabbageCustomEditor (CabbageCustomProcessor& p)
...
CabbageCustomEditor::~CabbageCustomEditor()
{
...
void CabbageCustomEditor::refreshValueTreeListeners()
{
...
void CabbageCustomEditor::setCurrentPreset(String preset)
{
    cabbageProcessor.currentPresetName = preset;
}

String CabbageCustomEditor::getCurrentPreset()
{
    return cabbageProcessor.currentPresetName;
}

void CabbageCustomEditor::resized()
{
...
void CabbageCustomEditor::moveBehind(String thisComp, String otherComp)
{
...
////======================================================================================================
//void CabbageCustomEditor::filesDropped(const StringArray &files, int x, int y)
//{
//    sendChannelStringDataToCsound("LAST_FILE_DROPPED", files[0]);
//}
//
//bool CabbageCustomEditor::isInterestedInFileDrag(const StringArray &files)
//{
//    return true;
//}
//======================================================================================================

void CabbageCustomEditor::mouseMove (const MouseEvent& e)
{
    handleMouseMovement (e);
}

void CabbageCustomEditor::mouseDrag (const MouseEvent& e)
{
    handleMouseMovement (e);
}

void CabbageCustomEditor::mouseDown (const MouseEvent& e)
{
    handleMouseClicks (e, true);
}

void CabbageCustomEditor::mouseUp (const MouseEvent& e)
{
    handleMouseClicks (e, false);
}

void CabbageCustomEditor::mouseWheelMove(const MouseEvent &event, const MouseWheelDetails &wheel)
{
    ignoreUnused(event);
    DBG(wheel.deltaY);
...
void CabbageCustomEditor::handleMouseMovement (const MouseEvent& e)
{
...
void CabbageCustomEditor::handleMouseClicks (const MouseEvent& e, bool isMousePressed)
{
...
//==============================================================================
void CabbageCustomEditor::createEditorInterface (ValueTree widgets)
{
    components.clear();
...
//======================================================================================================
void CabbageCustomEditor::setupWindow (ValueTree widgetData)
{
...
//======================================================================================================
void CabbageCustomEditor::addNewWidget (String widgetType, juce::Point<int> position, bool isCustomPlant)
{
...
//======================================================================================================
void CabbageCustomEditor::insertWidget (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertCheckbox (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertComboBox (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertRangeSlider (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertLabel (ValueTree cabbageWidgetData)
{
    CabbageLabel* label;
...
void CabbageCustomEditor::insertListBox (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertStringSequencer (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertMeter (ValueTree cabbageWidgetData)
{
    CabbageMeter* meter;
...
void CabbageCustomEditor::insertPath (ValueTree cabbageWidgetData)
{
    CabbagePath* path;
...
void CabbageCustomEditor::insertTextEditor (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertSoundfiler (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertSlider (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertEncoder (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertXYPad (ValueTree cabbageWidgetData)
{
    CabbageXYPad* xyPad;
...
void CabbageCustomEditor::insertFileButton (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertPresetButton (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertSignalDisplay (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertInfoButton (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertOptionButton (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertButton (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertNumberSlider (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertGenTable (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertTextBox (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertCsoundOutputConsole (ValueTree cabbageWidgetData)
{
    if (consoleCount < 1)
    {
...
void CabbageCustomEditor::insertKeyboard (ValueTree cabbageWidgetData)
{
    if (keyboardCount < 1)
    {
...
void CabbageCustomEditor::insertKeyboardDisplay(ValueTree cabbageWidgetData)
{
...
//======================================================================================================
void CabbageCustomEditor::insertGroupBox (ValueTree cabbageWidgetData)
{
...
void CabbageCustomEditor::insertImage (ValueTree cabbageWidgetData)
{
    CabbageImage* image;
...
void CabbageCustomEditor::insertLine (ValueTree cabbageWidgetData)
{
    CabbageImage* line;
...
void CabbageCustomEditor::insertPort (ValueTree cabbageWidgetData)
{
    CabbagePort* port;
...
void CabbageCustomEditor::insertScrew (ValueTree cabbageWidgetData)
{
    CabbageScrew* screw;
...
void CabbageCustomEditor::insertLight (ValueTree cabbageWidgetData)
{
    CabbageLight* light;
...
//======================================================================================================
CabbagePluginParameter* CabbageCustomEditor::getParameterForComponent (const String name)
{
...
//======================================================================================================
void CabbageCustomEditor::resizePlugin (int sizeIndex)
{
...
//======================================================================================================
void CabbageCustomEditor::comboBoxChanged (ComboBox* combo)
{
...
//======================================================================================================
//======================================================================================================
void CabbageCustomEditor::buttonClicked(Button* button)
{
...
void CabbageCustomEditor::buttonStateChanged(Button* button)
{
	if (CabbageButton* cabbageButton = dynamic_cast<CabbageButton*> (button))
	{
		const ValueTree valueTree = CabbageWidgetData::getValueTreeForComponent(cabbageProcessor.cabbageWidgets, cabbageButton->getName());
...
void CabbageCustomEditor::toggleButtonState(Button* button, bool state)
{
	if (CabbagePluginParameter* param = getParameterForComponent(button->getName()))
	{
		param->beginChangeGesture();
...
//======================================================================================================
void CabbageCustomEditor::sliderValueChanged (Slider* slider)
{
...
void CabbageCustomEditor::sliderDragStarted(Slider* slider)
{
...
void CabbageCustomEditor::sliderDragEnded(Slider* slider)
{
...
//======================================================================================================
void CabbageCustomEditor::enableEditMode (bool enable)
{
#if Cabbage_IDE_Build
...
//======================================================================================================
void CabbageCustomEditor::setCurrentlySelectedComponents (StringArray componentNames)
{
    currentlySelectedComponentNames = componentNames;
}

void CabbageCustomEditor::resetCurrentlySelectedComponents()
{
    currentlySelectedComponentNames.clear();
}

Component* CabbageCustomEditor::getComponentFromName (String& name)
{
...
Array<ValueTree> CabbageCustomEditor::getValueTreesForCurrentlySelectedComponents()
{
...
ValueTree CabbageCustomEditor::getValueTreeForComponent (String compName)
{
...
void CabbageCustomEditor::updateLayoutEditorFrames()
{
#if Cabbage_IDE_Build
...
//======================================================================================================
void CabbageCustomEditor::addToEditorAndMakeVisible (Component* comp, ValueTree widgetData)
{
...
void CabbageCustomEditor::addMouseListenerAndSetVisibility (Component* comp, ValueTree wData)
{
...
void CabbageCustomEditor::addPlantToPopupPlantsArray (ValueTree wData, Component* plant)
{
...
//======================================================================================================
void CabbageCustomEditor::updatefTableData (GenTable* table)
{
    if (!cabbageProcessor.getEngine())
        return;
...
//======================================================================================================
void CabbageCustomEditor::sendChannelDataToCsound (String channel, float value)
{
    if (csdCompiledWithoutError() && cabbageProcessor.getEngine())
        cabbageProcessor.getEngine()->SetChannel (channel.getCharPointer(), value);
}

float CabbageCustomEditor::getChannelDataFromCsound (String channel)
{
    if (csdCompiledWithoutError() && cabbageProcessor.getEngine())
...
void CabbageCustomEditor::sendChannelStringDataToCsound (String channel, String value)
{
...
void CabbageCustomEditor::sendScoreEventToCsound (String scoreEvent)
{
    if (cabbageProcessor.csdCompiledWithoutError() && cabbageProcessor.getEngine())
        cabbageProcessor.getEngine()->InputMessage(scoreEvent.toUTF8());
}

void CabbageCustomEditor::createEventMatrix(int cols, int rows, String channel)
{
    if (cabbageProcessor.csdCompiledWithoutError())
        cabbageProcessor.createMatrixEventSequencer(cols, rows, channel);
}

void CabbageCustomEditor::setEventMatrixData(int cols, int rows, String channel, String data)
{
    if (cabbageProcessor.csdCompiledWithoutError())
...
const Array<float, CriticalSection> CabbageCustomEditor::getArrayForSignalDisplay (const String signalVariable, const String displayType)
{
...
bool CabbageCustomEditor::shouldUpdateSignalDisplay(String signalVariableName)
{
    return cabbageProcessor.shouldUpdateSignalDisplay(signalVariableName);
}

void CabbageCustomEditor::enableXYAutomator (String name, bool enable, Line<float> dragLine)
{
    cabbageProcessor.enableXYAutomator (name, enable, dragLine);
}

void CabbageCustomEditor::disableXYAutomators()
{
    cabbageProcessor.disableXYAutomators();
}

bool CabbageCustomEditor::csdCompiledWithoutError()
{
    return cabbageProcessor.csdCompiledWithoutError();
}

StringArray CabbageCustomEditor::getTableStatement (int tableNumber)
{
    if (csdCompiledWithoutError())
...
const Array<float, CriticalSection> CabbageCustomEditor::getTableFloats (int tableNumber)
{
    if (csdCompiledWithoutError())
...
CabbageCustomProcessor& CabbageCustomEditor::getProcessor()
{
    return cabbageProcessor;
}

void CabbageCustomEditor::savePluginStateToFile (String presetName, String fileName, bool removePreset)
{
...
void CabbageCustomEditor::restorePluginStateFrom (String presetName, String filename)
{
    cabbageProcessor.restorePluginPreset (presetName, filename);
}

void CabbageCustomEditor::refreshComboListBoxContents(String presetName)
{
...
String CabbageCustomEditor::createNewGenericNameForPresetFile()
{
    Array<File> dirFiles;
...
//======================================================================================================
const String CabbageCustomEditor::getCsoundOutputFromProcessor()
{
